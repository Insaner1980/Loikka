...
export const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          { cols: ["Pikajuoksut", "8.54"] },
          { cols: ["Keskimatkat", "2:34.56"] },
  ...
  },
  {
    ...
    keywords: ["kilpailu", "lisää", "osallistuja", "taso", "SM", "PM", "piiri", "seura", "KLL", "koululiikuntaliitto"],
    content: [
      {
        type: "heading",
      ...
      {
        type: "table",
        headers: ["Taso", "Selitys"],
        rows: [
          { cols: ["SM", "Suomen mestaruuskilpailut"] },
          { cols: ["PM", "Pohjoismaiden mestaruuskilpailut"] },
          { cols: ["KLL", "Koululiikuntaliitto"] },
          { cols: ["Piiri", "Piirin kilpailut"] },
          { cols: ["Alue", "Aluekilpailut"] },
          { cols: ["Seura", "Seuran sisäiset kilpailut"] },
          { cols: ["Muu", "Muut kilpailut"] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        rows: [
          { cols: ["Pikajuoksut", "60m, 100m, 200m, 400m"] },
          { cols: ["Keskimatkat", "800m, 1000m, 1500m"] },
